...
function mapToEditedRecipeDto(editedRecipe) {
	return {
		...
		CookTime: isFalsishOrEmpty(editedRecipe.cookTime) ? 0 : editedRecipe.cookTime,
		PrepTime: isFalsishOrEmpty(editedRecipe.prepTime) ? 0 : editedRecipe.prepTime,
		Servings: isFalsishOrEmpty(editedRecipe.servings) ? 0 : editedRecipe.servings,
